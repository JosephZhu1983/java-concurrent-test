...
public class CompletableFutureTest {
    ...
    public void testCompletableFuture() throws ExecutionException, InterruptedException {
        ...
        Order order1 = CompletableFuture.supplyAsync(() -> Services.getOrder(orderId))
                .whenCompleteAsync((order, __) -> CompletableFuture.allOf(
                        ...
                        CompletableFuture.allOf(CompletableFuture.supplyAsync(() -> Services.calcOrderPrice(order.getItemPrice(), order.getUser().getVip())).thenAccept(order::setOrderPrice),
        ...
        log.info("CompletableFuture order:{} took:{}", order1, System.currentTimeMillis() - begin);
    }
    ...
    public void testNormal() {
        ...
        log.info("Normal order:{} took:{}", order, System.currentTimeMillis() - begin);
    }
}
