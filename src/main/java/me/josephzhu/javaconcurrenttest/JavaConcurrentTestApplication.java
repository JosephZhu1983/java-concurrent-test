...
//		testCases.add(new TestCase(element_count, Mode.ConcurrentProducerAndConsumer, Runtime.getRuntime().availableProcessors(), Runtime.getRuntime().availableProcessors()));
        ...
        testCases.add(new TestCase(element_count, Mode.ConcurrentProducerAndConsumer, 1, 10));
        testCases.add(new TestCase(element_count, Mode.ConcurrentProducerAndConsumer, 10, 1));
